...
norm.stats <- rep(NA,4)
for(i in 1:4){
  norm.stats[i] <- qnorm(q[i],22,7)
}
d <- cbind(d,norm.stats)
d
...
$$
f_{Z}(z) = \frac{1}{\sqrt{2\pi}}e^{-\frac{x^2}{2}}
$$
$$
F_{Z}(z) = \frac{1}{2} (1 + erf(\frac{x}{\sqrt{2}}))
$$

Using the cdf method,

$$
F_{X}(x) = P(X \leq x) = P(Z^{2} \leq x) = P(Z \leq \sqrt{x}) = F_{Z}(\sqrt{x})
$$
$$
F_{Z}(\sqrt{x}) =
\int_{-\sqrt{x}}^{\sqrt{x}}
...
$$
F_{Z}(\sqrt{x}) = 2 \frac{1}{2}erf (\frac{\sqrt{x}}{\sqrt{2}})
$$

$$
F_{Z}(\sqrt{x}) = erf (\frac{\sqrt{x}}{\sqrt{2}})
$$

$$
f_{X}(x) =
\frac{\partial}{\partial x} F_{Z}(\sqrt{x})=
f_{Z}(\sqrt{x}) \frac{1}{2}x^{-\frac{1}{2}}
$$

$$
f_{X}(x) =
\frac{1}{\sqrt{2\pi}}e^{-\frac{x}{2}} \frac{1}{2}x^{-\frac{1}{2}}
$$

$$
f_{X}(x) = \frac{x^{-\frac{1}{2}}e^{-\frac{x}{2}}}{2 \sqrt{2\pi}}
$$
...
$$
f_{X}(x) = \frac{x^{-\frac{1}{2}}e^{-\frac{x}{2}}}{2 \Gamma(1/2)}
$$
