...
-\frac{n}{\theta^3}3\theta^{2} + \frac{1}{3\theta^3}\sum_i^n{x_i^{2}} = 0
$$

$$
\frac{3n}{\theta} = \frac{\sum_i^n x_{i}^2}{3\theta^3}
$$

$$
\theta = \sqrt{
\frac{\sum_i^n x_{i}^2}{9n}
}
$$
...
n <- length(x)
analytical.sol <- sqrt(sum(x^2)/9*n)
# Plot
...
It does appear that the analytical solution (the red line) is at the maximum of the log likelihood function.
